clear;clc;close all;
tic;
global tf h Tdata parameter_a beta r N_dof N_harm Q
...
parameter_a(2,:)=[-0.5,0.0001,2,1];% 一阶谐波初值
...
for UU=4.2:0.05:4.5
    ...
    for iii=1:Nmax
        ...
        %%
        residual_iden=cal_residual_bifurcation(parameter_a);
        ...
        for trust=1:Ntr
            ...
            residual_da=cal_residual_bifurcation(parameter_a);
...
%         every_a(iii).parameter_a=parameter_a;
    ...
    jjj=jjj+1;
    residua=cal_residual_bifurcation(parameter_a);
...
% residual=cal_residual_bifurcation(parameter_a);
% figure;
