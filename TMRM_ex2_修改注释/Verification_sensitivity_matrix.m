...
%% 计算残差
residual=calculate_residual(parameter_a);
%% 绘制残差曲线
% figure;
...
%     
%     residual1=calculate_residual(parameter_a);
%     aaaa=(residual1-residual)/ddt;
%     figure; 
%     plot(time_data,residual(:,2*(i+1)+1),'r-')
%     hold on
%     plot(time_data,residual(:,2*(i+2)),'r-')
%     hold on
%     
