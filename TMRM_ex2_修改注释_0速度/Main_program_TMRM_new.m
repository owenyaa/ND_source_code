...
harmonic_coefficients(2, :) = [0.35, 0.002, 0.13, 0.03];  % Initial values for the first-order harmonics
...
coefficients_check = @(harmonic_coefficients)(abs(harmonic_coefficients) < 1);
